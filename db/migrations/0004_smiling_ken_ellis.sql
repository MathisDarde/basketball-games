...
ALTER TABLE "market_card_exchange" ADD CONSTRAINT "market_card_exchange_givenCardsId_playersData_id_fk" FOREIGN KEY ("givenCardsId") REFERENCES "public"."playersData"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
